...
export default function WorkLabel({ image = "yellowcircle", label }: WorkLabelType) {
  return (
    <div className="flex items-center mt-[110px]">
      <Image src={`./assets/${image}.svg`} alt={image} width={18} height={18} className="flex-none"/>
      <span className="px-[14px] text-[#FFFFFF] text-[25.14px] font-bold uppercase flex-none">
        {label}{" "}
      </span>
